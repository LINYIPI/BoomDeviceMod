...
GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X4X", "X7X", Character.valueOf('4'), new ItemStack(BD_boomfood1.block, 1), Character.valueOf('7'), new ItemStack(Items.gunpowder, 1), 
});}
...
static{
block = (Item)(new BlockCustomFood(4, 0.3F, true));block = ((BlockCustomFood)block).setUnlocalizedName("Boomfood2").setTextureName("boomfood2").setCreativeTab(BD_BDTab.tab);
block.setMaxStackSize(1);
Item.itemRegistry.addObject(433, "Boomfood2", block);
