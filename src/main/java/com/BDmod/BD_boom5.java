...
import net.minecraftforge.common.util.*;public class BD_boom5{
...
GameRegistry.addRecipe(new ItemStack(helmet, 1), new Object[]{
	"X1X", "X4X", "XXX", Character.valueOf('1'), new ItemStack(BD_boom4.helmet, 1), Character.valueOf('4'), new ItemStack(Items.gunpowder, 1), 
});
