...
GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X4X", "X7X", Character.valueOf('4'), new ItemStack(Items.egg, 1), Character.valueOf('7'), new ItemStack(Items.gunpowder, 1), 
});}
...
static{
block = (Item)(new BlockCustomFood(4, 0.3F, true));block = ((BlockCustomFood)block).setUnlocalizedName("Boomfood1").setTextureName("boomfood1").setCreativeTab(BD_BDTab.tab);
block.setMaxStackSize(1);
Item.itemRegistry.addObject(428, "Boomfood1", block);
