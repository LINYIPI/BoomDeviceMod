...
import net.minecraftforge.common.util.*;public class BD_boom2{
...
GameRegistry.addRecipe(new ItemStack(helmet, 1), new Object[]{
	"X1X", "X4X", "XXX", Character.valueOf('1'), new ItemStack(BD_boom1.helmet, 1), Character.valueOf('4'), new ItemStack(Items.gunpowder, 1), 
});
...
static{
ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("BOOM2", 0, new int[] {0, 0, 0, 0}, 0);

int armorPreffix = 0;if(FMLCommonHandler.instance().getEffectiveSide()==Side.CLIENT) armorPreffix = RenderingRegistry.addNewArmourRendererPrefix("boom2");
...
}).setUnlocalizedName("boom2_helmet").setTextureName("boom2_helmet");helmet.setMaxStackSize(1);
...
Item.itemRegistry.addObject(429, "boom2_helmet", helmet);
